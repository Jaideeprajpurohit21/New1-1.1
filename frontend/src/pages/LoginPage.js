    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-8">
        <div className="text-center text-white max-w-md">
          <h1 className="text-4xl font-bold mb-6">Lumina</h1>
          <p className="text-xl mb-4">AI-Powered Receipt Management</p>
          <p className="text-lg opacity-90">
            Transform your receipts into categorized, accounting-ready data with the power of AI.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                {isLogin 
                  ...
                  : 'Join Lumina to manage your receipts'}
              </p>
            </div>
            ...
            <button
              onClick={googleLogin}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 font-medium transition-colors mb-6"
            >
              ...
              {!isLogin && formData.password && (
                <div className="text-sm">
                  ...
                  <ul className="space-y-1">
                    {['At least 8 characters long', 'One uppercase letter', 'One lowercase letter', 'One number', 'One special character (!@#$%^&*(),.?":{}|<>)'].map((req, index) => {
                      const isValid = !passwordErrors.includes(req);
                      return (
                        <li key={index} className={`flex items-center gap-2 ${isValid ? 'text-green-600' : 'text-red-600'}`}>
